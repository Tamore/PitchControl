    ...
    <group ref={groupRef} visible={isVisible}>
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            className={cn(
              "cursor-pointer overflow-hidden rounded-[2px] shadow-sm transition-transform duration-200",
              hovered && "scale-125 shadow-md ring-1 ring-white/50",
            )}
            style={{
              width: "30px",
              height: "20px",
...
const defaultConfig: Required<Globe3DConfig> = {
  radius: 2,
  globeColor: "#1a1a2e",
  textureUrl: "https://unpkg.com/three-globe/example/img/earth-day.jpg", // Modified to light texture
